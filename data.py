...
class myAugmentation(object):
	...
	def __init__(self, data_path='./data', image_path="train/image", label_path="train/label", \
					   deform_path='./deform', \
	...
	def doAugmentate(self, img, save_to_dir, save_prefix, batch_size=1, save_format='tif', imgnum=3):
	...
	def splitMerge(self):
		...
		for i in range(self.slices):
			...
			for imgname in train_imgs:
				...
				cv2.imwrite(savedir_image+"/"+midname+"_train"+"."+self.img_type,img_train)
				cv2.imwrite(savedir_label+"/"+midname+"_train"+"."+self.img_type,img_label)
...
class dataProcess(object):
	...
	def __init__(self, out_rows, out_cols, \
		...
		self.label_path = os.path.join(data_path, label_path)
		#
		self.test_path  = test_path #os.path.join(data_path, test_path)
		self.img_type   = img_type
